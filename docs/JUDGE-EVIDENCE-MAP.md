...
Evidence updated September 8, 2026. FrameKind is a caption and audio-description review workspace for film editors. It proposes repairs, lets an editor approve or keep the original, and exports the resulting captions and review report.
...
| Public source and license | [GitHub repository](https://github.com/Abhinav0905/Google_All_Agentic_Cinema), [Apache-2.0 license](../LICENSE), [setup](../README.md) | Public head `7184eff` includes FrameKind core revision `5a5f9a0` and the first evidence documents. This Replit-status update needs a follow-up push. The existing license is Apache-2.0. |
| Replit development and hosting | [Replit project](https://replit.com/@abhinav0905/GoogleAllAgenticCinema), [actual verification record](REPLIT_VERIFICATION.md), [.replit](../.replit) | Agent checked Python 3.11, Node 20, FFmpeg/FFprobe and Postgres reachability, added `postgresql-16` to the Replit workspace and ran the build script. Quota stopped the full task. Manual Shell checks confirmed build output and imports; Run preview displays FrameKind. Public publishing and hosted runtime checks remain pending. The [Replit track requirements](https://agentic-cinema.devpost.com/details/replit-resources) require both Agent use and Replit hosting. |
