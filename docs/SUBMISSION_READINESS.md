...
| Persistence after republishing | Browser sample `595edd8f` retained 19 findings and one approved edit after `c0fc1f3` was published. Video metadata remained 01:00. Its new 1,189-byte SRT was byte-for-byte identical to the earlier download. |
